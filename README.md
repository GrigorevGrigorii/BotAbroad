...
- `/subscriptions` - управление подписками на страны.
...
- `tools`
  ...
  - `corona_infos_collector`

      Таска, которая обновляет данные о коронавирусе для всех стран и делает расслыку по подпискам
